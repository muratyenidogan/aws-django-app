...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/murat/capstone/username", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/murat/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cn6wcss6ovbn.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'aws-capstones-murat-blog' # please enter your s3 bucket name
